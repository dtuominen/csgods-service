...
DIR_STEAMCMD="/home/csgoserver/steamcmd"
STEAM_LOGIN="anonymous"
STEAM_PASSWORD=""
STEAM_RUNSCRIPT="$DIR_STEAMCMD/runscript_$SCREEN_NAME"

DIR_ROOT="/home/csgoserver/serverfiles"
...
API_AUTHORIZATION_KEY="`cat $DIR_GAME/webapi_authkey.txt`" # http://steamcommunity.com/dev/registerkey
WORKSHOP_COLLECTION_ID="219093060" # http://steamcommunity.com/sharedfiles/filedetails/?id=125499818
WORKSHOP_START_MAP="122443683" # http://steamcommunity.com/sharedfiles/filedetails/?id=125488374

# Game config
MAXPLAYERS="14"
TICKRATE="128"
EXTRAPARAMS="+tv_enable 1 +tv_delay 10 +sv_pure 1 +game_type 0 +game_mode 1"

PARAM_START="-debug -game csgo -console -usercon -high -secure -steam_dir ${DIR_STEAMCMD} -steamcmd_script ${STEAM_RUNSCRIPT} -maxplayers_override ${MAXPLAYERS} -tickrate ${TICKRATE} +hostport ${PORT} +ip ${IP} +net_public_adr ${IP} ${EXTRAPARAMS} +host_workshop_collection 219093060"
